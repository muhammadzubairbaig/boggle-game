...
//   boardSize,
// }) => {
//   // Use fixed values for tile size and gap to avoid DOM measurements
//   const FIXED_TILE_SIZE = 48; // Fixed at 48px for both 4x4 and 5x5
//   const FIXED_GAP = 8; // Fixed at 8px for both 4x4 and 5x5
...
//   // Calculate line start and end points, stopping 4px outside the tile's edge
...
//   // Calculate SVG dimensions based on fixed tile size and gap
